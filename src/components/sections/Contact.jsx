    ...
    return (
        <motion.section
            ...
            <div className="max-w-xl mx-auto h-full flex flex-col items-center justify-center ">
                <h2 className={`${theme === 'dark' ? 'text-mainTxt' : 'text-black'} text-5xl lg:text-7xl font-bold mb-4 text-primary flex justify-center `}>Get In Touch</h2>
                ...
                border-[0.1rem] hover:-translate-y-1 transition-all duration-300 delay-75`}>Let's Talk!</a>
            </div>
        </motion.section>
    )
}
