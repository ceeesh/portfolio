    ...
    return (
        <section className='h-96 my-16'>
            <div className="max-w-xl mx-auto h-full flex flex-col items-center justify-center">
                <h2 className="text-5xl font-bold mb-4 text-primary inline-flex text-[#FBEBD8]">Get In Touch</h2>
                ...
                <a className="px-12 py-2.5 text-lg rounded-md border-[0.1rem] border-[#EFD09E] text-[#FBEBD8]">Say Hello !</a>
            </div>
        </section>
    )
}
