...
const Projects = () => {
    ...
    return (
        <section className="min-h-screen">
            ...
            <div className="w-full flex items-center justify-center"><a className="bg-btnbg px-12 py-2.5 text-lg rounded-md text-mainTxt border-[0.1rem] border-secondaryTxt font-medium">See more</a></div>
        </section>
    )
}
