...
const Intro = () => {
  return (
    <motion.section variants={staggerContainer(0.4, 1.3)} initial="hidden" animate="show"
      ...
      <motion.p variants={fade(0.8, .8)} className="absolute -right-2 md:-bottom-2 lg:-bottom-2 lg:right-0 text-8xl font-bold text-btnbg flex flex-col justify-end items-end uppercase z-0">
        <span>m</span>
        <span>a</span>
        <span>l</span>
        <span>a</span>
