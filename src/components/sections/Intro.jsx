...
const Intro = () => {
  ...
  return (
    <motion.section variants={staggerContainer(0.4, 1.3)} initial="offscreen" animate="onscreen"
      ...
      <Link to='/projects'> <motion.a variants={fade(0.8, .7)} className=" z-20 px-12 py-2.5 text-lg rounded-md border-[0.1rem] bg-btnbg border-mainTxt text-mainTxt hover:bg-btnHvr hover:-translate-y-1 transition all duration-300 delay-75">Projects</motion.a></Link>
